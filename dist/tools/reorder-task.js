...
export function registerReorderTaskTool(server, client) {
    server.registerTool("paul_reorder_task", {
        title: "Reorder a PAUL task (spends a weekly move)",
        description: "Move a PENDING task to another position in the user's open list " +
