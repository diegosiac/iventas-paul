...
export function registerGetCheckpointTool(server, client) {
    server.registerTool("paul_get_checkpoint", {
        title: "Get PAUL checkpoint questions",
        description: "Request PAUL's 3 AI validation questions for a task. THIS BEGINS THE " +
