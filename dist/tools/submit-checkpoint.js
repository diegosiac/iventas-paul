...
export function registerSubmitCheckpointTool(server, client) {
    server.registerTool("paul_submit_checkpoint", {
        title: "Submit PAUL checkpoint answers",
        description: "Submit answers to PAUL's validation questions to close a task. HARD " +
